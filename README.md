...
- **Infrastructure**: Google Cloud Run, Cloudflare Pages, k3s (Home Server Cluster), **Grobid (WSL2)**
- **Data Base**: PostgreSQL (App Data & Logs), Google Cloud Storage
- **AI Optimization**: [DSPy Prompt Optimization](./prompt_optimization/README.md)
