...
class SidebarNoteService:
    ...
    def _add_guest_note(self, session_id: str, note_dict: dict) -> None:
        ...
        self.cache.set(
            _guest_note_session_key(note_id), session_id, expire=_SESSION_TTL
        )

    def _get_guest_notes(
    ...
    def _set_user_notes_cache(
        ...
        self.cache.set(
            _user_notes_cache_key(user_id, paper_id), notes, expire=_SESSION_TTL
        )
    ...
    def delete_note(
        self, note_id: str, user_id: str | None = None, paper_id: str | None = None
    ) -> bool:
        """
        Delete a note.
        ...
        try:
            ...
            if deleted:
                ...
                logger.warning(
                    "Note not found for deletion", extra={"note_id": note_id}
                )
            return deleted
        except Exception as e:
            logger.exception(
