...
const PDFViewer: React.FC<PDFViewerProps> = ({
      ...
      es.onmessage = (event) => {
        try {
          ...
          if (eventData.type === "page") {
            ...
            if (eventData.paper_id) setPaperId(eventData.paper_id);
            if (eventData.full_text) setFullText(eventData.full_text);
  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-2 md:p-4 relative min-h-full pb-20">
      ...
      {/* Content Area */}
      {mode === "plaintext" ? (
        <TextModeViewer paperId={paperId} fullText={fullText} />
      ) : (
        <div
