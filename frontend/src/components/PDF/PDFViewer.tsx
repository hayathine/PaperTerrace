...
const PDFViewer: React.FC<PDFViewerProps> = ({ uploadFile, onWordClick, onTextSelect, onAreaSelect, sessionId, jumpTarget, evidenceHighlight, onStatusChange, onPaperLoaded, onAskAI, onFigureClick, onTableClick }) => {
    const { token } = useAuth();
