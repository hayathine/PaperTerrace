...
const TextModePage: React.FC<TextModePageProps> = ({ page, onWordClick, onTextSelect, jumpTarget }) => {
    ...
    const handleMouseUp = (e: React.MouseEvent) => {
        ...
        setTimeout(() => {
            ...
            if (selection && selection.rangeCount > 0 && selectionText && selectionText.length > 0) {
    ...
    return (
        <div 
            ...
            style={{ maxWidth: '100%', userSelect: 'none', containerType: 'inline-size' }} 
